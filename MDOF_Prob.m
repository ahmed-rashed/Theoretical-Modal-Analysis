...
for ignoreTransient=ignoreTransientVector
    figureTitle1=[x_rows_Y_label_col{1},' due to $f_{1} (t)=\sin\left(\Omega_{1}t\right)$'];
    figureTitle2=[x_rows_Y_label_col{2},' due to $f_{1} (t)=\sin\left(\Omega_{1}t\right)$'];
...
for ignoreTransient=ignoreTransientVector
    figureTitle1=[x_rows_Y_label_col{1},' due to $f_{2} (t)=\sin\left(\Omega_{2}t\right)$'];
    figureTitle2=[x_rows_Y_label_col{2},' due to $f_{2} (t)=\sin\left(\Omega_{2}t\right)$'];
