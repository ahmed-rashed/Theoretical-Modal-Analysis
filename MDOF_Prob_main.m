...
M_mat,K_mat,M_mat\K_mat %#ok<NOPTS>

m_row=[1,2,2];
n_row=[1,1,2];

%% Undamped system
C_mat=zeros(N,N),t_final=10;t_row=linspace(0,t_final,n_points);MDOF_Prob(M_mat,C_mat,K_mat,x_0_col,x_dot_0_col,m_row,n_row,t_row,f_column,true) %#ok<NOPTS>
...
C_mat=10000*eps*ones(N,N),MDOF_Prob(M_mat,C_mat,K_mat,x_0_col,x_dot_0_col,m_row,n_row,t_row,f_column,true) %#ok<NOPTS>
...
C_mat=2/15*M_mat+K_mat/1500,t_final=20;t_row=linspace(0,t_final,n_points);MDOF_Prob(M_mat,C_mat,K_mat,x_0_col,x_dot_0_col,m_row,n_row,t_row,f_column,true) %#ok<NOPTS>
...
C_mat=[0.8,-0.1;-0.1,0.3],t_final=15;t_row=linspace(0,t_final,n_points);MDOF_Prob(M_mat,C_mat,K_mat,x_0_col,x_dot_0_col,m_row,n_row,t_row,f_column,false) %#ok<NOPTS>
